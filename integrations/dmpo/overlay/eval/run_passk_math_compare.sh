...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/passk_math_compare}"
GPU_IDS="${GPU_IDS:-1,2}"
...
run_eval_job() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu_id" python "$PROJECT_ROOT/eval_passk_math_single.py" \
...
python "$PROJECT_ROOT/combine_passk_math.py" "${COMBINE_ARGS[@]}"
