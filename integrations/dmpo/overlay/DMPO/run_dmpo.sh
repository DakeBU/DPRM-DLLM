...
LOSS_PROGRESSIVE_DPRM_WARMUP_POLICY="${DPRM_WARMUP_POLICY:-${LOSS_PROGRESSIVE_DPRM_WARMUP_POLICY:-confidence}}"
...
MASKING_ARGS=(
    ...
    --loss_progressive_dprm_warmup_policy "${LOSS_PROGRESSIVE_DPRM_WARMUP_POLICY}"
