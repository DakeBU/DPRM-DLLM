...
Anonymous review implementation of paper *DPRM: A Plug-in Token-Ordering Module for Diffusion Language Models*.
...
If this repository is useful, cite the anonymous DPRM-DLLM paper submission and the relevant host paper used in your experiment. A `CITATION.cff` template is provided with anonymized review metadata.
